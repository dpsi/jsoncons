...
public:
...

    {
        ...
        structure_stack_.push_back({0,structure_type::root_t});
    }
...
private:
    ...
    bool do_begin_object(semantic_tag tag, const ser_context&) override
    {
        ...
        structure_stack_.push_back({item_stack_.size()-1,structure_type::object_t});
        return true;
    }
    ...
    bool do_begin_array(semantic_tag tag, const ser_context&) override
    {
        ...
        structure_stack_.push_back({item_stack_.size()-1,structure_type::array_t});
        return true;
    }
